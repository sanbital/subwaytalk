...
/* permission */
.perm-screen{flex:1;display:flex;flex-direction:column;background:linear-gradient(168deg,#CFEFDE 0%,#A9E2C5 58%,#9BDBBB 100%);min-height:0}
.perm-hero{flex:1;display:flex;align-items:center;justify-content:center;padding:30px 28px 10px;min-height:0}
.perm-hero img{width:80%;max-width:300px;border-radius:30px;box-shadow:0 20px 44px rgba(18,110,82,.20);display:block}
.perm-sheet{background:#fff;border-radius:30px 30px 0 0;padding:24px 24px 28px;box-shadow:0 -12px 34px rgba(20,60,46,.10)}
.perm-sheet .tag{font-size:16px;font-weight:800;line-height:1.5;text-align:center;margin:2px 0 18px;letter-spacing:-0.012em;color:var(--ink)}
.perm-sheet .tag b{color:var(--c-d)}
.perm-sheet .cta{background:var(--c);color:#fff;border:none;border-radius:15px;padding:16px;font-size:15px;font-weight:800;width:100%;
  cursor:pointer;box-shadow:0 8px 18px rgba(22,199,166,.32);transition:.15s} .perm-sheet .cta:active{transform:scale(.985)}
.perm-sheet .consent{font-size:11px;color:var(--muted);line-height:1.6;margin:14px 4px 0;text-align:center}
.perm-sheet .plinks{display:flex;flex-wrap:wrap;justify-content:center;gap:6px 12px;margin-top:14px}
.perm-sheet .plinks a{font-size:11px;color:var(--faint);text-decoration:underline;cursor:pointer}
.perm-sheet .alt{text-align:center;margin-top:16px;font-size:12px}
.perm-sheet .alt button{background:none;border:none;color:var(--c-d);font-weight:700;text-decoration:underline;cursor:pointer;font-size:12px}
...
/* 접근 게이트 (관리자/광고주) */
.gatewrap{min-height:100vh;display:flex;align-items:center;justify-content:center;background:var(--bg);padding:24px}
.gatecard{width:100%;max-width:370px;background:#fff;border:1px solid var(--line);border-radius:20px;padding:28px 24px;box-shadow:var(--sh);text-align:center}
.gatelogo{font-size:15px;font-weight:800;margin-bottom:6px} .gatelogo .dot{color:var(--c)} .gatelogo b{color:var(--c-d)}
.gatecard p{font-size:13px;color:var(--muted);margin:8px 0 18px}
.gatecard input{width:100%;background:var(--paper2);border:1.5px solid var(--line);border-radius:13px;padding:14px;font-size:15px;outline:none;font-family:inherit;text-align:center;letter-spacing:.05em}
.gatecard input:focus{border-color:var(--c)}
.gatecard .gobtn{width:100%;margin-top:12px;background:var(--c);color:#fff;border:none;border-radius:13px;padding:14px;font-size:15px;font-weight:800;cursor:pointer}
...
/* 라운지 음악 플레이어 */
.music{background:var(--paper);border:1px solid var(--line);border-radius:18px;padding:13px 15px;box-shadow:var(--sh)}
.music .top{display:flex;align-items:center;gap:12px}
.music .disc{width:42px;height:42px;border-radius:50%;background:radial-gradient(circle at 50% 50%,#2a2e36 0 22%,var(--c) 23% 100%);flex:none;position:relative;
  box-shadow:0 2px 8px rgba(22,199,166,.3)}
.music .disc::after{content:"";position:absolute;inset:0;margin:auto;width:9px;height:9px;border-radius:50%;background:var(--paper)}
.music .disc.spin{animation:spin 3.6s linear infinite} @keyframes spin{to{transform:rotate(360deg)}}
.music .info{flex:1;min-width:0}
.music .theme{font-size:11px;color:var(--c-d);font-weight:800}
.music .song{font-size:13.5px;font-weight:700;margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--ink)}
.music .ctl{display:flex;align-items:center;gap:4px;flex:none}
.music .ctl button{background:none;border:none;color:var(--ink);cursor:pointer;width:34px;height:34px;border-radius:9px;font-size:15px;
  display:flex;align-items:center;justify-content:center} .music .ctl button:hover{background:var(--paper2)}
.music .ctl .pp{background:var(--c);color:#fff;width:38px;height:38px;font-size:16px} .music .ctl .pp:hover{background:var(--c-d)}
.music .volrow{display:flex;align-items:center;gap:9px;margin-top:11px}
.music .volrow input[type=range]{flex:1;accent-color:var(--c);height:3px}
.music .volrow .x{background:none;border:none;color:var(--faint);font-size:11.5px;cursor:pointer;white-space:nowrap;font-weight:600}
.music .blocked{display:flex;align-items:center;gap:10px}
.music .blocked .msg{flex:1;font-size:13px;font-weight:700}
.music .blocked .startbtn{background:var(--c);color:#fff;border:none;border-radius:11px;padding:9px 15px;font-size:13px;font-weight:800;cursor:pointer}
.music .blocked .skip{background:none;border:none;color:var(--faint);font-size:12px;cursor:pointer;white-space:nowrap}
.music .offrow{display:flex;align-items:center;gap:10px;font-size:12.5px;color:var(--muted)}
.music .offrow button{margin-left:auto;background:var(--c-soft2);border:1px solid var(--c-soft);color:var(--c-d);border-radius:10px;padding:8px 14px;font-weight:800;cursor:pointer;font-size:12.5px}
...
const DEFAULT_LINES = {
  "2호선": { color:"#00A84D", stations:[
    {n:"시청",lat:37.5657,lng:126.9769},{n:"을지로입구",lat:37.5660,lng:126.9826},{n:"을지로3가",lat:37.5662,lng:126.9919},
    {n:"동대문역사문화공원",lat:37.5652,lng:127.0078},{n:"신당",lat:37.5656,lng:127.0202},{n:"상왕십리",lat:37.5644,lng:127.0294},
    {n:"왕십리",lat:37.5614,lng:127.0378},{n:"한양대",lat:37.5557,lng:127.0438},{n:"뚝섬",lat:37.5474,lng:127.0473},
    {n:"성수",lat:37.5447,lng:127.0558},{n:"건대입구",lat:37.5404,lng:127.0701},{n:"구의",lat:37.5372,lng:127.0857},
    {n:"강변",lat:37.5349,lng:127.0946},{n:"잠실나루",lat:37.5206,lng:127.1031},{n:"잠실",lat:37.5133,lng:127.1001},
    {n:"잠실새내",lat:37.5121,lng:127.0862},{n:"종합운동장",lat:37.5110,lng:127.0735},{n:"삼성",lat:37.5089,lng:127.0631},
    {n:"선릉",lat:37.5045,lng:127.0490},{n:"역삼",lat:37.5006,lng:127.0364},{n:"강남",lat:37.4979,lng:127.0276},
    {n:"교대",lat:37.4934,lng:127.0143},{n:"서초",lat:37.4917,lng:127.0078},{n:"방배",lat:37.4815,lng:126.9974},
    {n:"사당",lat:37.4765,lng:126.9816},{n:"낙성대",lat:37.4769,lng:126.9636},{n:"서울대입구",lat:37.4812,lng:126.9527},
    {n:"봉천",lat:37.4824,lng:126.9417},{n:"신림",lat:37.4842,lng:126.9296},{n:"신대방",lat:37.4875,lng:126.9133},
    {n:"구로디지털단지",lat:37.4853,lng:126.9015},{n:"대림",lat:37.4933,lng:126.8956},{n:"신도림",lat:37.5089,lng:126.8911},
    {n:"문래",lat:37.5176,lng:126.8956},{n:"영등포구청",lat:37.5246,lng:126.8961},{n:"당산",lat:37.5343,lng:126.9024},
    {n:"합정",lat:37.5497,lng:126.9136},{n:"홍대입구",lat:37.5571,lng:126.9245},{n:"신촌",lat:37.5550,lng:126.9366},
    {n:"이대",lat:37.5567,lng:126.9462},{n:"아현",lat:37.5573,lng:126.9558},{n:"충정로",lat:37.5599,lng:126.9636} ] },
  "공항철도": { color:"#0090D2", stations:[
    {n:"서울역",lat:37.5547,lng:126.9707},{n:"공덕",lat:37.5443,lng:126.9514},{n:"홍대입구",lat:37.5571,lng:126.9245},
    {n:"디지털미디어시티",lat:37.5765,lng:126.8965},{n:"마곡나루",lat:37.5675,lng:126.8295},{n:"김포공항",lat:37.5631,lng:126.8014},
    {n:"계양",lat:37.5715,lng:126.7359},{n:"검암",lat:37.5694,lng:126.6736},{n:"청라국제도시",lat:37.5360,lng:126.6510},
    {n:"영종",lat:37.4930,lng:126.5410},{n:"운서",lat:37.4925,lng:126.4940},{n:"공항화물청사",lat:37.4607,lng:126.4513},
    {n:"인천공항1터미널",lat:37.4470,lng:126.4526},{n:"인천공항2터미널",lat:37.4030,lng:126.4710} ] },
  "경의중앙선": { color:"#77C4A3", stations:[
    {n:"일산",lat:37.6820,lng:126.7695},{n:"대곡",lat:37.6359,lng:126.8112},{n:"행신",lat:37.6122,lng:126.8336},
    {n:"디지털미디어시티",lat:37.5765,lng:126.8965},{n:"가좌",lat:37.5685,lng:126.9155},{n:"홍대입구",lat:37.5571,lng:126.9245},
    {n:"서강대",lat:37.5510,lng:126.9357},{n:"공덕",lat:37.5443,lng:126.9514},{n:"효창공원앞",lat:37.5392,lng:126.9613},
    {n:"용산",lat:37.5298,lng:126.9648},{n:"이촌",lat:37.5223,lng:126.9745},{n:"서빙고",lat:37.5197,lng:126.9885},
    {n:"한남",lat:37.5294,lng:127.0093},{n:"옥수",lat:37.5403,lng:127.0177},{n:"응봉",lat:37.5497,lng:127.0344},
    {n:"왕십리",lat:37.5614,lng:127.0378},{n:"청량리",lat:37.5800,lng:127.0469},{n:"회기",lat:37.5895,lng:127.0577},
    {n:"중랑",lat:37.5949,lng:127.0772},{n:"상봉",lat:37.5963,lng:127.0856},{n:"망우",lat:37.5996,lng:127.0922},
    {n:"구리",lat:37.6034,lng:127.1438},{n:"덕소",lat:37.5790,lng:127.2117},{n:"양평",lat:37.4920,lng:127.4940},
    {n:"용문",lat:37.4838,lng:127.5945} ] },
};
...
function nearestStation(lat,lng){ let best=null;
  ...
  return best; }
const LOGO = "data:image/jpeg;base64,";
...
function parseYT(url){
  ...
  try{
    ...
    if(list && !/^RDAMVM|^RDEM/.test(list)) return { type:"playlist", id:list };
    if(u.hostname.includes("youtu.be")){ const id=u.pathname.slice(1); if(id) return { type:"video", id }; }
...
function loadYT(){
  ...
  ytReadyPromise = new Promise((res, rej)=>{
    const prev = window.onYouTubeIframeAPIReady;
    window.onYouTubeIframeAPIReady = ()=>{ if(prev) try{prev();}catch{} res(); };
    const tag = document.createElement("script");
    tag.src = "https://www.youtube.com/iframe_api";
    tag.onerror = ()=> rej(new Error("yt load failed"));
    document.head.appendChild(tag);
    setTimeout(()=>{ if(!(window.YT && window.YT.Player)) rej(new Error("yt timeout")); }, 8000);
  });
...
function acquireFirstFix({ timeout = 20000 } = {}){
...
/* ============================================================ 라운지 음악 플레이어 */
function MusicPlayer({ source, theme, onOff }){
  const elRef = useRef(null); const playerRef = useRef(null);
  ...
  useEffect(()=>{
    let dead = false;
    loadYT().then(()=>{
      if(dead || !elRef.current || !window.YT) return;
      const opts = source.type==="playlist"
        ? { playerVars:{ listType:"playlist", list:source.id, autoplay:1, controls:0, playsinline:1, rel:0 } }
        : { videoId:source.id, playerVars:{ autoplay:1, controls:0, playsinline:1, rel:0 } };
      playerRef.current = new window.YT.Player(elRef.current, {
        height:"0", width:"0", ...opts,
        events:{
          onReady:(e)=>{ try{ e.target.setVolume(vol); e.target.playVideo(); }catch{}
            setTimeout(()=>{ try{ if(e.target.getPlayerState()!==1) setBlocked(true); }catch{} }, 1400);
            try{ const d=e.target.getVideoData(); if(d&&d.title) setSong(d.title); }catch{} },
          onStateChange:(e)=>{ setPlaying(e.data===1); if(e.data===1) setBlocked(false);
            try{ const d=e.target.getVideoData(); if(d&&d.title) setSong(d.title); }catch{} },
  ...
  const toggle = ()=>{ const q=p(); if(!q) return; if(playing) q.pauseVideo(); else { q.playVideo(); setBlocked(false); } };
  const start = ()=>{ const q=p(); if(!q) return; try{ q.unMute(); q.setVolume(vol); q.playVideo(); }catch{} setBlocked(false); };
  const toggleMute = ()=>{ const q=p(); if(!q) return; if(muted){ q.unMute(); setMuted(false); } else { q.mute(); setMuted(true); } };
  const changeVol = (val)=>{ setVol(val); const q=p(); if(q){ q.setVolume(val); if(val>0 && muted){ q.unMute(); setMuted(false); } } };
  const next = ()=>{ const q=p(); if(q && q.nextVideo) q.nextVideo(); };

  if(failed) return (
    <div className="music"><div className="offrow">
      <span>🎵 이 편성은 임베드 재생이 제한된 콘텐츠예요.</span>
      <button onClick={onOff}>닫기</button>
    </div></div>
  );

  return (
    <div className="music">
      <div ref={elRef} style={{position:"absolute",width:0,height:0,overflow:"hidden",pointerEvents:"none"}}/>
      {blocked ? (
        <div className="blocked">
          <span className="msg">🎵 라운지 음악이 준비됐어요</span>
          <button className="startbtn" onClick={start}>음악 시작</button>
          <button className="skip" onClick={onOff}>안 들을래요</button>
        </div>
      ) : (
        <>
          <div className="top">
            ...
            <div className="info">
              ...
              <div className="song">{song || (playing ? "재생 중" : "라운지 음악")}</div>
            </div>
            <div className="ctl">
              <button className="pp" onClick={toggle}>{playing ? "❚❚" : "▶"}</button>
              <button onClick={toggleMute}>{muted ? "🔇" : "🔊"}</button>
              <button onClick={next} title="다음 곡">⏭</button>
            </div>
          </div>
          <div className="volrow">
            <span style={{fontSize:13}}>{muted?"🔇":"🔊"}</span>
            <input type="range" min="0" max="100" value={muted?0:vol} onChange={e=>changeVol(Number(e.target.value))}/>
            <button className="x" onClick={onOff}>음악 끄기</button>
          </div>
        </>
      )}
    </div>
...
function LoungeApp(){
  ...
  const [locMode, setLocMode] = useState("pending"); // pending | mock | real
  ...
  const startMatch = async () => {
    ...
    try{
      ...
      setLocMode("real"); applyFix(fix); setGeoErr("");
      setTimeout(()=>setScreen("lounge"), 900);
    }catch(err){
      setLocMode("mock");
      setGeoErr(err && err.code===1
        ? "위치 권한이 꺼져 있어 체험 모드로 시작해요. 설정에서 허용하면 같은 방향 라운지에 연결됩니다."
        : "아직 위치를 잡지 못해 체험 모드로 시작해요. 신호가 잡히면 자동으로 전환됩니다.");
      setTimeout(()=>setScreen("lounge"), 1200);
    }
  };

  // 엔진 판정 구독. 체험 모드로 시작했더라도 신호가 잡히면 실제 모드로 승격한다.
  // (터널 출발 → 지상 구간 진입, 역사 와이파이 접속 등)
  useEffect(()=>{
    if(screen!=="lounge") return;
    const onFix = (e)=>{
      applyFix(e.detail);
      setLocMode((m)=> m==="real" ? m : "real");
      setGeoErr("");
    };
    window.addEventListener("subway:location", onFix);
  ...
  if(screen==="perm") return (
    <div className="scr perm-screen">
      <div className="perm-hero"><img src={LOGO} alt="칙칙톡톡"/></div>
      <div className="perm-sheet">
        <p className="tag">같은 방향으로 이동하는 동안만,<br/><b>익명으로 도란도란.</b></p>
        <button className="cta" onClick={startMatch}>위치정보 수집·이용에 동의하고 입장하기</button>
        <p className="consent">입장하기를 누르면 위치정보 수집·이용 및 위치 기반 라운지 연결에 동의한 것으로 봅니다. 위치정보는 라운지 매칭 · 자동 하차 감지 · 역 도착 안내 목적으로만 이용되며, 다른 이용자나 광고주에게 제공되지 않아요.</p>
        <div className="plinks">
          <a onClick={()=>alert("위치정보 이용약관 (준비 중)")}>위치정보 이용약관</a>
          <a onClick={()=>alert("개인정보 처리방침 (준비 중)")}>개인정보 처리방침</a>
    ...
    <div className="scr">
      <div className={"lh"+(arrNow?" arr":"")}>
        <div className="row1"><span className="ico" style={{display:"inline-flex",alignItems:"center"}}><TrainMark size={19} color={arrNow?"#0A8F77":"#16C7A6"}/></span>
          {headTitle}
          <span className="cnt">{isReal ? `함께 이동 중 ${count}명` : "체험 모드"}</span></div>
        {!isReal && geoErr && <div className="geonotice">{geoErr}</div>}
        <div className="track">
          <div className="base"/>
...
function Cards({cards,setCards,refresh}){
  ...
  return (<>
    ...
    <div className="panel"><h3>새 카드 등록</h3>
      ...
      <div className="fld"><label>플레이리스트 URL (유튜브 · 라운지 내 재생)</label><input value={url} onChange={e=>setUrl(e.target.value)} placeholder="https://www.youtube.com/playlist?list=... 또는 영상 URL"/></div>
...
function Ads({ads,setAds,adstats,refresh}){
  const [station,setStation]=useState("강변"); const [brand,setBrand]=useState("");
  ...
  return (<>
    ...
    <div className="panel"><h3>새 역 도착 광고</h3>
      <div className="fld"><label>도착역</label><select value={station} onChange={e=>setStation(e.target.value)}>{LINE_NAMES.map(ln=>(<optgroup key={ln} label={ln}>{LINES[ln].stations.map(st=><option key={ln+st.n} value={st.n}>{st.n}</option>)}</optgroup>))}</select></div>
